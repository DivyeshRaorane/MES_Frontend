...
const MENU = [
  ...
  },
  {
    ...
    color: 'text-rose-400',
    children: [
      { label: 'Temperature', path: '/qa/temperature'},
      { label: 'TRH Cycle',   path: '/qa/trhentry'},
      ...
      { label: 'Hot Water Test', path: '/qa/hotwatertest'},
      { label: 'Dynamic Fatigue', path: '/qa/dynamicfatigue'},
