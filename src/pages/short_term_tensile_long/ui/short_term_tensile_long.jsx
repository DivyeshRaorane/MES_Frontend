...
const ShortTermTensileLong = () => (
  <div className="h-full bg-slate-50 font-sans text-slate-800 flex flex-col overflow-hidden">
    <div className="flex flex-col flex-1 overflow-hidden px-3 py-2">
      <Formik initialValues={initialValues}
        onSubmit={(v) => { console.log('Long Tensile Entry:', v); alert('Saved!'); }}>
        {({ resetForm }) => (
          <Form className="flex flex-col flex-1 overflow-hidden gap-2">

            <ModuleCard compact title="Long Tensile Entry" icon={<TrendingUp size={12} className="text-blue-600" />}>
                ...
                <div className="flex flex-col flex-1 min-h-0 gap-1.5">
                  ...
                  <div className="flex-1 min-h-0 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                    <div className="bg-slate-50/80 px-3 py-1.5 border-b border-slate-200 flex items-center gap-2 flex-shrink-0">
                      ...
                      <span className="font-bold text-slate-700 text-[9px] uppercase tracking-wider">Long Tensile Strength Entry</span>
                    </div>
...
export default ShortTermTensileLong;
