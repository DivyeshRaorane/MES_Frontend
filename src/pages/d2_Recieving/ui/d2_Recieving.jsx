                ...
                <div className="w-full">
                  ...
                  >
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <FormikInput  compact label="Process Hours" name="processhours" type="number" placeholder="0" />
                        <FormikSelect compact label="Start Operator"          name="startoperator"
